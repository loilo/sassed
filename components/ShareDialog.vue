    ...
    >
      ...
      <div class="fixed inset-0 overflow-y-auto">
        ...
        >
          ...
          >
            <HeadlessDialogPanel
              class="sassed-prose w-full max-w-xl transform overflow-hidden rounded bg-white px-6 py-10 text-left align-middle shadow-xl transition-all prose-headings:my-0 prose-hr:my-8 dark:bg-slate-800 sm:px-8 sm:py-10 md:px-12 md:py-14"
            >
              ...
              <div class="mt-2 text-base">
                <p>
                  <template v-if="sharer.isSupported.value">
                    Use the button below to share your Sass code with others.
                  </template>
                  <template v-else>
                    Copy the URL below to share your Sass code with others:

                    <input
                      class="-mb-2 mt-6 w-full rounded border-2 border-slate-100 bg-slate-100 px-3 py-3 text-sm text-slate-600 focus:border-pink focus:outline-none dark:border-slate-600 dark:bg-slate-600 dark:text-slate-300 dark:focus:border-pink-400"
